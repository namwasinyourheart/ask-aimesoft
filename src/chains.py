...
def get_rag_chain():
    llm = get_llm()
    urls = [
        'https://www.aimesoft.com/',
        'https://www.aimesoft.com/company.html',
        'https://www.aimesoft.com/services.html',
        'https://www.aimesoft.com/products.html',
        'https://www.aimesoft.com/press.html'
        ]
