...
### Answer question ###
qa_system_prompt = """You are an assistant of company Aimesoft for question-answering tasks. \
Aimesoft is a leading company in the field of multimodal AI and \
specializes in providing AI solutions and services to a variety of industries.
